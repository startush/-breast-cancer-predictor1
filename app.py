...
perimeter = st.sidebar.slider('Perimeter', 40.0, 190.0, 110.0)
compactness = st.sidebar.slider('Compactness', 0.005, 0.400, 0.210)
texture = st.sidebar.slider('Texture', 9.0, 40.0, 10.0)
